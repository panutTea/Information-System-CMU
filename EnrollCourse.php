        ...
        <div class="row" style = "top: 15%; position: absolute;">
            ...
            <div class="col-md-auto" style =  "text-align: center; margin-left: 15;">
                <ul class="nav nav-tabs" style="font-size:22px; font-weight:bold;">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="http://127.0.0.1/OODProject/EnrollCourse.php">ลงทะเบียนเรียน</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="http://127.0.0.1/OODProject/StudyTable.php">ตารางเรียน</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="http://127.0.0.1/OODProject/StudentInfo.php">ตารางสอบ</a>
                    </li>
                </ul>
                <h5 style = "text-align: left; margin-top: 50;">ค้นหากระบวนวิชา</h5>
                <input style = "text-align: left; margin-top: 50;">Eat peace MTFK<br></input>
                <button>ค้นหา</button>
            </div>
        </div>
    </div>
